...
namespace API_GP_LOGISTICO.Controllers
{
    ...
    public class CallController : ApiController
    {
        ...
        //Trae listado de Confirmaciones pendientes de enviar =============
        ...
        //Marca como Traspasado un registro de la tabla L_IntegraConfirmaciones
        ...
        //recurso 43 Genera Consumo --------
        #region Genera Consumo (43)
        [HttpPost]
        ...
        public static void LogInfo(string NombreProceso, string Mensaje, bool GrabarSiempre = false, bool GuardaEnBD = false, string Referencia = "", string EstructuraJSON = "")
        {
            try
            {
                ...
                if (ConfigurationManager.AppSettings["RegistroArchivoLog"].ToString() == "SI" || GrabarSiempre == true)
                {
                    ...
                    html.Append("[" + NombreProceso.ToString() + "]. Fecha/Hora " + DateTime.Now.ToShortDateString() + " " + DateTime.Now.ToShortTimeString() + ". " + Mensaje.Trim());
